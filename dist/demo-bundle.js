...
const WireAPIClient_1 = __webpack_require__(10);
...
const ContentType_1 = __webpack_require__(11);
const StatusCode_1 = __webpack_require__(13);
class AuthAPI {
    constructor(client) {
        this.client = client;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
const AuthAPI_1 = __webpack_require__(9);
const HttpClient_1 = __webpack_require__(12);
class WireAPIClient {
    constructor(urls) {
        this.urls = urls;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__commonjs__ = __webpack_require__(8);
...
window.onload = function() {
  ...
  submitButton.onclick = function(event) {
    ...
    const client = new __WEBPACK_IMPORTED_MODULE_0__commonjs___default.a(urls);
    client.login(login)
      .then((result) => {
